...
وكالة الأساطير هي الشبكة المعتمدة رسمياً الأولى في الشرق الأوسط لإدارة وتطوير صناع المحتوى والمذيعين على تطبيقي تانجو (Tango) وزينا لايف (Zeena Live).
فلسفتك وأسلوبك:
...
2. المذيع يحتفظ بكامل أرباحه من التطبيق 100% ويحصل بالإضافة إليها على بونص شهري كاش إضافي من الوكالة عند تحقيق التارقت.
3. حماية الحسابات من البلاغات الكيدية، فك الحظر فورياً عبر خط مباشر 24/7 مع مسؤولي تانجو وزينا لايف.
4. كوتشينج مباشر وتجهيز إضاءة ومايك للوصول إلى قائمة الإكسبلور.
5. فريق الإدارة العليا: عبدالله (مالك الوكالة / Founder)، خالد، حسام، جميلي، وبلاك.
6. للتواصل المباشر مع المشرفين البشريين: واتساب الإدارة +905058167844 أو رابط الوكالة المباشر.
...
export function AIChat() {
  ...
  const initialGreeting = lang === 'ar'
    ? 'مرحباً بك في وكالة الأساطير! 👑 أنا مساعدك الذكي المتاح 24/7 للإجابة عن كل ما يخص الانضمام لبرامج البث على تانجو وزينا، البونصات الشهرية، والدعم الفني. كيف يمكنني مساعدتك اليوم؟'
    : 'Welcome to Legends Agency! 👑 I am your 24/7 AI Assistant ready to answer all your questions about joining our Tango & Zeena broadcasting programs, monthly cash bonuses, and VIP support. How can I help you today?';
